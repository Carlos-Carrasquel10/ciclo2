...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Comillas:
                    ...
                    break;
                case Comillas_simple:
                    resultado += "  <Comilla Simple>\t" + lexer.lexeme + "\n";
                    break;
                case For:
                    resultado += "  uso un iterador\t" + lexer.lexeme + "\n";
                    break; 
                case XOR:
                    resultado += "  <Operador XOR bit>\t" + lexer.lexeme + "\n";
                    break;
                case NOT:
                    resultado += "  <Operador NOT bit>\t" + lexer.lexeme + "\n";
                    break;
                case If:
                    resultado += "  <Reservada if>\t" + lexer.lexeme + "\n";
                    break;
                case Casetr:
                    resultado += "  <Reservada Nueva Casetr>\t" + lexer.lexeme + "\n";
                    break;
                case Else:
                ...
                case Especificadores:
                    resultado += "  <Especificadores>\t" + lexer.lexeme + "\n";
                    break;
                case Op_atribucion:
                ...
                case Op_booleano:
                    ...
                    break;
                case Null:
                    resultado += "  <Valor nulo>\t\t" + lexer.lexeme + "\n";
                    break;
                case Parentesis_a:
                ...
                case Return:
                    ...
                    break;
                case Void:
                    resultado += "  <No regresa un valor>\t" + lexer.lexeme + "\n";
                    break;
                case P_coma:
    ...
    private void initComponents() {
        ...
        txtResultado.setText("int main(){int var=0;\nprintf();\n}");
